...
//				requestLayout();
	...
	public void refreshFinish(int refreshResult)
	{
		...
		case SUCCEED:
			...
			refreshStateImageView.setBackgroundResource(R.drawable.refresh_succeed111);
			break;
		case FAIL:
		default:
			// 刷新失败
			...
			refreshStateImageView
					.setBackgroundResource(R.drawable.refresh_failed111);
			break;
		}
		if (pullDownY > 0)
		{
	...
	public void loadmoreFinish(int refreshResult)
	{
		...
		case SUCCEED:
			...
			loadStateImageView.setBackgroundResource(R.drawable.load_succeed111);
			break;
		case FAIL:
		default:
			// 加载失败
			...
			loadStateImageView.setBackgroundResource(R.drawable.load_failed111);
			break;
		}
		if (pullUpY < 0)
		{
