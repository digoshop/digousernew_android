package com.digoshop.app.module.storedetail.view;
...
public class MoreTextView extends LinearLayout{
	...
	protected void initalize() {
		...
		llp.width= App.getInstance().getResources().getDimensionPixelSize(R.dimen.base_dimen_60);
		llp.height=App.getInstance().getResources().getDimensionPixelSize(R.dimen.base_dimen_60);
