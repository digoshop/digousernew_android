package com.digoshop.app.module.home.view;
...
public class AutoVerticalScrollTextView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public View makeView() {
        ...
        textView.setTextSize( TypedValue.COMPLEX_UNIT_PX,getResources().getDimension(R.dimen.base_dimen_30));
        textView.setGravity(Gravity.CENTER_VERTICAL);
        textView.setEllipsize(TextUtils.TruncateAt.END);
        textView.setTextColor(getResources().getColor(R.color.home_search_text));
        return textView;
