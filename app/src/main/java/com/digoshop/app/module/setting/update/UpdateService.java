package com.digoshop.app.module.setting.update;
    ...
    private void startDownload( ) {
        UpdateManager.getInstance().startDownloads(apkURL, filePath, new UpdateDownloadListener() {
            ...
            public void onFinished(int completeSize, String downloadUrl) {
                ...
                Log.v("lsq","filePath"+filePath);
                Log.v("lsq","apkURL"+apkURL);
                Log.v("lsq","downloadUrl"+downloadUrl);
              ...
              //  App.getInstance().showToast(getString(R.string.update_download_finish));
                stopSelf();
