...
import static com.digoshop.R.id.re_couponleft;
 ...
 */
public class CouponactiveNewAdp extends BaseAdapter {
    ...
    public CouponactiveNewAdp(Context context, ArrayList<Discountcoupons> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = minflater.inflate(
                    R.layout.home_goucouponnew_item, null);
            ...
            holder.re_coupon_item_bg_ctid = (RelativeLayout) convertView
                    .findViewById(R.id.re_coupon_item_bg_ctid);
            holder.re_couponmiddle = (RelativeLayout) convertView
                    .findViewById(R.id.re_couponmiddle);
            ...
            holder.re_couponleft = (RelativeLayout) convertView.findViewById(re_couponleft);
        ...
        if (mlist.get(position).getCtid().equals("1000000")) {//优惠券类型//代金券/1000000
            ...
            holder.tv_coupon_item_money_cbca.setTextColor(mContext.getResources().getColor(R.color.tv_coupon_nhuang));
            holder.tv_coupon_item_money_cbca_name.setTextColor(mContext.getResources().getColor(R.color.tv_coupon_nhuang));
            holder.re_couponleft.setBackgroundResource(R.drawable.shape_lan_nhuang);
            holder.re_couponmiddle.setBackgroundColor(mContext.getResources().getColor(R.color.tv_coupon_nqhuang));
            ...
            holder.tv_coupon_item_money_cbca.setTextColor(mContext.getResources().getColor(R.color.tv_coupon_nlan));
            holder.tv_coupon_item_money_cbca_name.setTextColor(mContext.getResources().getColor(R.color.tv_coupon_nlan));
            holder.re_couponmiddle.setBackgroundColor(mContext.getResources().getColor(R.color.tv_coupon_nqlan));
            holder.tv_coupon_item_tiaojian_cbcf.setText("满" + mlist.get(position).getCbcf() + "可以用");
            holder.re_couponleft.setBackgroundResource(R.drawable.shape_lan_nlan);
            holder.tv_coupon_item_bg_ctid.setText("折扣券");
        } else if (mlist.get(position).getCtid().equals("1000002")) {//满减券/1000002
            holder.tv_coupon_item_tiaojian_cbcf.setVisibility(View.VISIBLE);
            holder.tv_coupon_item_money_cbca.setTextColor(mContext.getResources().getColor(R.color.tv_coupon_nred));
            holder.tv_coupon_item_money_cbca_name.setTextColor(mContext.getResources().getColor(R.color.tv_coupon_nred));
            holder.re_couponmiddle.setBackgroundColor(mContext.getResources().getColor(R.color.tv_coupon_nqred));
            holder.tv_coupon_item_bg_ctid.setText("满减券");
            holder.tv_coupon_item_tiaojian_cbcf.setText("满" + mlist.get(position).getCbcf() + "可以用");
            holder.re_couponleft.setBackgroundResource(R.drawable.shape_lan_nred);
        }
    ...
    public class viewholder {
        ...
        private RelativeLayout  re_couponleft, re_couponmiddle,re_coupon_item_bg_ctid;//优惠券类型//代金券/1000000 折扣券/1000001 满减券/1000002
