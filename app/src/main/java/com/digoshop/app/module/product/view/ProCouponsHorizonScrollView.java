package com.digoshop.app.module.product.view;
...
import com.digoshop.app.module.product.adp.ProCouponsItemAdapter;
import com.digoshop.app.module.userCenter.model.Discountcoupons;

import java.util.ArrayList;


public class ProCouponsHorizonScrollView extends HorizontalScrollView {
...
//    private TextTypeClickListener textTypeClickListener;
    ...
    public ProCouponsHorizonScrollView(Context context) {
        super(context);
        mContext = context;
        initView();
    }

    public ProCouponsHorizonScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }
    ...
    public void setListData(ArrayList<Discountcoupons> mpoitGoodBeanArrayList, TextTypeClickListener mtextTypeClickListener, int i) {
        ...
        ProCouponsItemAdapter mClubsItemAdapter = new ProCouponsItemAdapter(mContext, mpoitGoodBeanArrayList, i);
    ...
    public void setListData(ArrayList<Discountcoupons> mpoitGoodBeanArrayList, TextTypeClickListener mtextTypeClickListener, int i,int type) {
        ...
        ProCouponsItemAdapter mClubsItemAdapter = new ProCouponsItemAdapter(mContext, mpoitGoodBeanArrayList, i,type);
        mClubContainerLayout.removeAllViews();
        addViews(mClubsItemAdapter,mtextTypeClickListener);
    ...
    private void addViews(ProCouponsItemAdapter mClubsItemAdapter, TextTypeClickListener textTypeClickListener) {
