...
public final class SimpleGrid extends ViewGroup {
    ...
    private float mItemMarginHor=0;
    private float mItemMarginVer=0;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int hMargin =  DensityUtil.floatToInt(DensityUtil.px2dip(App.getInstance(),mItemMarginHor));
        final int vMargin =  DensityUtil.floatToInt((DensityUtil.px2dip(App.getInstance(),mItemMarginVer)));
